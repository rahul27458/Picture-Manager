...
xmlhttp.open("GET","getdeletehint.jsp?q="+str,true);
xmlhttp.send();
}
</script>
					...
					{	
									...
									try
									{
											...
											for(PostBean postBean : dataList) 
											{
												...
												<a href="/xyz/DisplayImages/?fileName=<%=fileName%>" rel="prettyPhoto"><img src="/xyz/DisplayImages/?fileName=<%=postBean.getFile_name()%>"  width="relative"  style="position:relative; left:100px;top:40px;" /></a><br/><br/><br/> 
										<br><br>
						...
						for(PostBean postBean : dataList) 
						{
								...
								<%if(breport)// user has not reported 
								  ...
								  %>
										...
										<form  onsubmit="return check_videocomment()" action= "../VideoCommentServlet?group_ids=<%=group_id%>" method="post">
...
<tr>
<td>
<font face="Comic Sans MS" size="4px"><a href="../LeaveGroup?user_id=<%=user_id%>&group_ids=<%=group_id%>">Leave the group</a></font>
<td>
</tr>
