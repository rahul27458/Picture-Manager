...
public class HomeVideoFileUploadServlet extends HttpServlet  {
	private static final long serialVersionUID = 1L;
	
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HomeVideoFileUploadServlet() {
        super();
				 ...
				 if(item.isFormField()){
					 ...
					 String path=getServletContext().getRealPath("/");
				      ...
				      try{
						...
						String str=("insert into videoupload(filename,user_id) values('"+filename+"','"+user_id+"')");
