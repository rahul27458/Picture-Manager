...
<title>Comments for video</title>
</head>
<body>
<!--header-->
<div class="header">
 ...
 <%
	  ...
	  try
	  {
				   ...
				   int video_id=Integer.parseInt(video_ids);
				    ...
				    String sqlret="select filename from videoupload where video_id='"+video_id+"'";
				    String sql1="select user_id,comment_text from v_comments where video_id='"+video_id+"'";
				    String sql2;
				    ...
				    rs1=st1.executeQuery(sql1);
				  	...
				  	if(rs.next())
				  	{
							  ...
							  <video width="320" height="240" controls="controls">
										<source src="/xyz/DisplayImages/?fileName=<%=fileName%>" type="video/mp4"></source>
												</video>
												<br/><br/><br/> 		    
							 <br><br><br><br>
							 </td></tr>
