...
(function ($) {
  ...
  <!--    <form enctype="multipart/form-data" action="ImageCropperSrv">
<input type="file" value="upload" name="upload"><br>
 <input type="submit" value="upload">
   ...
   %>
     ...
     <img src="/xyz/DisplayImages/?fileName=<%=fileName%>" id="cropbox" style="max-width:500px;">
     <form action="imagecroppersrv.jsp">
     <input type="hidden" name="file" value="<%=fileName%>" />
     <input type="hidden" name="image_id" value="<%=image_id%>" />
     <input type="hidden" name="user_id" value="<%=user_id_s%>" />
